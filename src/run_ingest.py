...
def run_ingestion(
    ...
    ingestor.preprocess_corpus(input_t1, db_t1, progress_callback=progress_callback)

    print(f"--- Processing {label_t2} from {input_t2} ---")
    ingestor.preprocess_corpus(input_t2, db_t2, progress_callback=progress_callback)
